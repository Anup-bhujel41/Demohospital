            ...
            <main role="main" class="col-md-12 ml-sm-auto px-4 container">
                <div class="admin-main">
                    ...
                    <div class="row container mb-3">
                        <div class="card col-md-3 mr-md-3 first-card">
                        ...
                        <div class="card col-md-3 mt-xs-3 mr-md-3 first-card">
                            <img src="../photos/patient2.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="row container">
                        <div class="card col-md-3 mt-xs-3 mr-md-3 first-card">
                            <img src="../photos/appointment.png" class="card-img-top" alt="...">
                            <div class="card-body">


                                <a href="admin_appointment.php" class="btn btn-primary">Appointments</a>
                            </div>
                        </div>

                        <div class="card col-md-3 mt-xs-3 mr-md-3 first-card">
                            <img src="../photos/medicalhistory.png" class="card-img-top" alt="...">
                            <div class="card-body">
